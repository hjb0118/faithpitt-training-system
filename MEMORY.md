...
- 培训记录 49 条（R1~R64，nextId=65）：已通过 42 / 30天已回访 6 / 已完成 1
...
- [2026-09-23](logs/2026-09-23.md) 全量代码审查；安全加固 3 项（静态文件任意下载 / register 越权 / SSH 密码硬编码）；环境修复（Node 22）；建立 MEMORY.md + logs/ 日志制度
...
5. 涉及数据变更时：手动同步 training.db（见第五章）
